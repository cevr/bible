...
| **James Waterhouse studies** | Chiastic structural analyses                                                                                                                                        | Reveals the architecture inside the Daniel/Rev text — which verses pair with which      | [james-waterhouse-studies/](james-waterhouse-studies/)         |
...
- **Waterhouse integration rule:** structural findings surface as observations about the text itself ("Notice the chiastic structure of Dan 8-11..."), never cited as "Waterhouse says."
- **The same applies to DAR:** Smith's identifications (Vicarius Filii Dei = 666, Litch's 1840, etc.) are facts about the text + history, not "Smith says" appeals.
...
- `james-waterhouse-studies/studies/00-INDEX.md` — find the Waterhouse file mapped to Study N
