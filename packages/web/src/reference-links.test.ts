...
describe('linkReferences', () => {
  test('links Bible passages to Bible Gateway in the KJV', () => {
    const html = linkReferences(
      '<p>Read John 3:16, 18 and 1 Corinthians 13:1–3; compare Gen. 1:26, Exo. 25:8, Eze. 4:6, and 1 Th. 5:23.</p>',
      PANELS,
    );

    expect(html).toContain(
      '<a href="https://www.biblegateway.com/passage/?search=John%203%3A16%2C%2018&version=KJV" target="_blank" rel="noopener noreferrer">John 3:16, 18</a>',
    );
    expect(html).toContain(
  ...
  test('links resolved EGW citations to their exact paragraph panel', () => {
    const html = linkReferences('<p>The two classes remained separate (PP 81.2).</p>', PANELS);
